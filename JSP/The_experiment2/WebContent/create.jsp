	...
	<form action="<%=request.getContextPath()%>/StudentServlet" method="post">
		...
		<table class="table table-bordered table-hover definewidth m10">
		    ...
		    <tr>
		        ...
		        <td><input type="text" name="birthday"/>输入格式为xxxx-xx-xx</td>
		    </tr>
		    <tr>
		    ...
		    <tr>
		        ...
		        <td>
		            <button type="submit" class="btn btn-primary" type="button">添加学生</button>
		            <span style="color:red">${requestScope.createMsg}</span>
		        </td>
		    </tr>
		</table>
	</form>
